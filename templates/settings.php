...
<form action="" method="post">
 ...
 <?php
  ...
  <td>
		<?php
		$saved_forms = ! empty( $meta['disable_track'] ) ? $meta['disable_track'] : [];

		foreach ( $forms_arr as $k => $v ) {

			?>
<p><label for="vx_form_<?php echo $k; ?>"><input type="checkbox" name="meta[disable_track][<?php echo $k; ?>]" value="yes" 
								  <?php 
									if ( vxcf_form::post( $k, $saved_forms ) == 'yes' ) {
										echo 'checked="checked"';} 
									?>
 id="vx_form_<?php echo $k; ?>"><?php echo $v; ?></label></p>
			<?php 
		} 
		?>
</td>
...
<?php } ?>  
  ...
  <td>
<label for="vx_cookies"><input type="checkbox" name="meta[cookies]" value="yes" 
<?php 
if ( vxcf_form::post( 'cookies', $meta ) == 'yes' ) {
	echo 'checked="checked"';} 
?>
 id="vx_cookies"><?php _e( 'Check this to disable user tracking cookies. This will disable Related Entries and Form Abandonment feature', 'contact-form-entries' ); ?></label>
  </td>
  </tr>
  ...
  <td>
<label for="vx_ip"><input type="checkbox" name="meta[ip]" value="yes" 
<?php 
if ( vxcf_form::post( 'ip', $meta ) == 'yes' ) {
	echo 'checked="checked"';} 
?>
 id="vx_ip"><?php _e( 'Check this to disable IP address and User Agent(Browser ) tracking.', 'contact-form-entries' ); ?></label>
  </td>
  </tr>
  ...
  <td>
<label for="vx_plugin_data"><input type="checkbox" name="meta[plugin_data]" value="yes" 
<?php 
if ( vxcf_form::post( 'plugin_data', $meta ) == 'yes' ) {
	echo 'checked="checked"';} 
?>
 id="vx_plugin_data"><?php _e( 'Remove all plugin data during plugin uninstall', 'contact-form-entries' ); ?></label>
  </td>
  </tr>
  </table>
  <?php
